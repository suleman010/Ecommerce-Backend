...
public class ProductController {
    ...
    @PostMapping("/in/subcategory/{subCategoryId}")
    public void addProduct(@PathVariable Long subCategoryId,@RequestBody ProductDto productDto){
        productService.addProduct(subCategoryId,productDto);
    }
    @PutMapping("/{id}")
